...
const MOCK: ClienteRow[] = [
  { id: "CL-001", nome: "Ana Souza", email: "ana@example.com", status: "Ativo" },
  { id: "CL-002", nome: "Bruno Lima", email: "bruno@example.com", status: "Ativo" },
  { id: "CL-003", nome: "Carla Paiva", email: "carla@example.com", status: "Inativo" },
  { id: "CL-004", nome: "Diego Matos", email: "diego@example.com", status: "Ativo" },
  { id: "CL-005", nome: "Elisa Prado", email: "elisa@example.com", status: "Ativo" },
  { id: "CL-006", nome: "Felipe Araújo", email: "felipe@example.com", status: "Ativo" },
  { id: "CL-007", nome: "Gabriela Reis", email: "gabi@example.com", status: "Inativo" },
  { id: "CL-008", nome: "Gabriela Reis", email: "gabi@example.com", status: "Inativo" },
];
      ...
      <div className="mb-5 rounded-xl bg-gray-300 p-3">
        <div className="flex items-center gap-3">
          <div className="mr-auto flex w-full max-w-md items-center rounded-xl bg-white px-3 py-2 ring-1 ring-gray-200">
            <span className="mr-2 text-sm text-gray-400"><MagnifyingGlass size={18}/></span>
            <input
