    ...
    <NotificationProvider>
      <UIProvider>
        <div className="flex h-screen overflow-hidden">
          ...
          <main className="flex-1 h-full w-full p-4 bg-[#E0E0E0] overflow-hidden">
            {/* AQUI: h-full e sem overflow-y-auto */}
